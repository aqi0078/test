...
@Slf4j
public class AARetrofitFactory extends Converter.Factory {
    public static AARetrofitFactory create(){

        return new AARetrofitFactory();}
    ...
    public Converter<?, RequestBody> requestBodyConverter(Type type,
        ...
        return value -> AARetrofitFactory.RequestMapper.INSTANCE.apply(value).toRequestBody();
    }
    @ToString
    @Getter
    ...
    private enum RequestMapper implements Function<Object, AARetrofitFactory.HttpRequest> {
        INSTANCE;

        @Override
        public AARetrofitFactory.HttpRequest apply(Object o) {
            Object request = o;
            JSONObject wrapper = JSON.parseObject(JSON.toJSONString(request));
            if (request instanceof RetrofitRequset) {
                RetrofitRequset spr = (RetrofitRequset) request;
            ...
            return AARetrofitFactory.HttpRequest.of(MERCHANT_ACCOUNT, data, encryptKey);
        }
...
//            return new RankBodyConverter<>();
        ...
        return value -> {
            try {
                ...
                return AARetrofitFactory.HttpResponse.of(json);
//                    return json;
            } finally {
                value.close();
            }
